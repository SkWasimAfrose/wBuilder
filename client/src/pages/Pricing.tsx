  ...
  return (
    ...
    <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
      <div className='text-center mt-16'>
        <h1 className='text-3xl font-medium text-gray-100'>Choose Your Plan</h1>
        <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'> Starts for free and scale up as you grow. Find the plan that best fits your needs.</p>
      </div>
      ...
      <div className='pt-14 py-4 px-4 '>
                ...
                <div>
                  <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Projects <span className='text-white font-medium'>Crearion / Revision </span> Consume <span className='text-white font-medium'>5 Credits</span>. You can purchase to create more projects</p>
                </div>
    </div>
    <Footer/>
    </>
